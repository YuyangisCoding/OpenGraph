...
def parse_args():
    ...
    parser.add_argument('--trndata', default='', type=str, help='name of train dataset')
    parser.add_argument('--tstdata', default='', type=str, help='name of test dataset')
    parser.add_argument('--tst_epoch', default=25, type=int, help='number of epoch to test while training')
